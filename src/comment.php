...
<p class='comment-flag' <?php if(0): ?> style='display:none;'<?php endif;?> ><?php echo __("Show sentiment"); ?></p>
<p class='comment-unflag' <?php if(1): ?>style='display:none;'<?php endif;?> ><?php echo __($comment->flagged." (Hide sentiment)"); ?></p>
<?php endif; ?>
